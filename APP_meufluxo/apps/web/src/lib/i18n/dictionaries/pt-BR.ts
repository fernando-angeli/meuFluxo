...
export const ptBR = {
  ...
  "filters.paymentMethod.placeholder": "Forma de pagamento",
  "filters.paymentMethod.all": "Todas",
  "filters.paymentMethod.debit": "Débito em conta",
  "filters.paymentMethod.cash": "Dinheiro",
  "filters.paymentMethod.transfer": "Transferência",
  "filters.paymentMethod.boleto": "Boleto",
  "filters.paymentMethod.va": "Vale alimentação",
  "filters.paymentMethod.invoiceCard": "Fatura cartão",
  "filters.all": "Todos",
  ...
  "pages.categories.drawer.hint": "Dados da categoria e subcategorias.",
  "pages.categories.edit": "Editar categoria",
  "pages.categories.details.summaryTitle": "Resumo",
  "pages.categories.details.noDescription": "Sem descrição cadastrada.",
  "pages.categories.details.subcategoryCountLabel": "Quantidade de subcategorias",
  "pages.categories.subcategories.heading": "Subcategorias ({count})",
  "pages.categories.subcategories.new": "Nova subcategoria",
  "pages.categories.subcategories.showingRange": "Mostrando {start}-{end} de {total}",
  "pages.categories.subcategories.previous": "Anterior",
  "pages.categories.subcategories.next": "Próxima",
  ...
  "expenses.form.settleImmediately": "Liquidar agora",
  "expenses.form.settleImmediatelyHint":
    "Gera a movimentação na conta na data de vencimento e marca o lançamento como liquidado.",
  "expenses.form.settleImmediatelyAria": "Liquidar lançamento ao criar",
  ...
  "expenses.validation.accountInvalid": "Conta selecionada inválida.",
  "expenses.validation.accountInactive":
    "Esta conta está inativa. Reative-a ou escolha outra conta para o lançamento.",
  "expenses.validation.settleOnlySingle": "Liquidar na criação só está disponível para lançamento único.",
  "expenses.validation.settleRequiresAccount": "Selecione a conta para liquidar na criação.",
  "expenses.validation.settleRequiresSubCategory":
    "Selecione uma subcategoria para poder liquidar na criação.",
