...
class CreditCardInvoicePaymentServiceTest {
    ...
    void createShouldGenerateCashMovementAndLinkPaymentToMovement() {
        ...
        ArgumentCaptor<com.meufluxo.cashmovement.dto.CashMovementRequest> movementCaptor =
                ArgumentCaptor.forClass(com.meufluxo.cashmovement.dto.CashMovementRequest.class);
