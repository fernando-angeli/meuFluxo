package com.meufluxo.planning.service;
...
import com.meufluxo.planning.dto.*;
...
import com.meufluxo.planning.mapper.PlannedEntryMapper;
...
public class PlannedEntryService extends BaseUserService {
    ...
    public PageResponse<PlannedEntryResponse> findExpenses(
            ...
            com.meufluxo.planning.model.PlannedAmountBehavior amountBehavior,
            LocalDate issueDate,
